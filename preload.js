...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getCareerFolderPath: () => ipcRenderer.invoke('bugReport:getCareerFolderPath'),
  openCareerFolder: () => ipcRenderer.invoke('bugReport:openCareerFolder'),
  showBugReportFileDialog: (options) => ipcRenderer.invoke('bugReport:showFileDialog', options),
